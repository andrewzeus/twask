...
import com.doublesunflower.twask.utils.other.DateUtilities;
import com.doublesunflower.twask.utils.other.Preferences;
import com.doublesunflower.twask.utils.other.TaskFieldsVisibility;
 ...
 *
 */
public class TwaskListAdapter extends ArrayAdapter<TaskModelForList> {
    ...
    private TwaskListAdapterHooks hooks;
     ...
     *
     */
    public interface TwaskListAdapterHooks {
     ...
     * @param hooks
     */
    public TwaskListAdapter(Activity activity, int resource,
            List<TaskModelForList> objects, TwaskListAdapterHooks hooks) {
    ...
    public void setExpanded(View view, TaskModelForList task, boolean state) {
        try {
            ...
            Log.e("Twask", "Error in setExpanded", e);
        }
    }
